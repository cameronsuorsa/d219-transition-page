...
define('D219_TRANSITION_VERSION', '1.8.6');
...
function d219_get_candidate_bios() {
    ...
    $flat['sharon-imes']['video'] = '<iframe src="https://www.youtube.com/embed/vwvzO1UWNKY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
    $flat['sharon-imes']['answers'] = array(
        ...
        'honors' => '2 Congratulatory Letters from TI for leading two clubs to President\'s Distinguish 2025. Appreciation Plaque from District Director, Jing Humphreys, DTM for helping District 13 become a Smedley Distinguished District in 2024 by starting a new club in Western Maryland. Started two community clubs and had the Charter / Induction Ceremony as two Red Carpet event. One club has a State Senator as a Charter Member in PA, and a State Senator as a Keynote Speaker in Maryland, and a Governor\'s ad Senator\'s Citation for the only club in Western Maryland. Won District 13 International Speech Contest 2022. Negotiated a $10K sponsorship for District 46 TM Conference in NY i Chaired. Distinguished Toastmaster Award. Distinguished Division.',
